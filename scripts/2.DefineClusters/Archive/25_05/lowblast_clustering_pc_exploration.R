...
png("figures/lowblast_pc_cluster/lowblasts_clinical.png", width = 1000, height = 1000)
plot_grid(plotlist = low_clin_plots, nrow = 3)
dev.off()

png("figures/lowblast_pc_cluster/lowblasts_clinical_violin.png", width = 1000, height = 1000)
clinical_low %>%
...
png("figures/lowblast_pc_cluster/lowblasts_karevents_prop.png")
...
png("figures/lowblast_pc_cluster/lowblasts_mutevents_prop.png")
pheatmap(mat = mut_tabs_lowblasts, display_numbers = TRUE)
dev.off()


## IPSSM
png("figures/lowblast_pc_cluster/lowblast_clust_ipssm.png")
table(clinical_low$clust, clinical_low$IPSSM) %>%
    as.matrix() %>%
    pheatmap(display_numbers = TRUE, cluster_cols = FALSE)
dev.off()

png("figures/lowblast_pc_cluster/lowblast_clust_ipssm_prop.png")
...
png("figures/lowblast_pc_cluster/lowblasts_survival.png")
surv_low$plot 
dev.off()
